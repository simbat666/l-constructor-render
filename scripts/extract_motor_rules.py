...
DEFAULT_SOURCE = ROOT / "data" / "rules-source" / "ОЛ - Электродвигатель асинхронный_В2 [9rOgKs]-рабочая.xlsx"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--revision", default="В2 9rOgKs · Excel-driven engine keys", help="Human-readable source revision stored in JSON")
